...
import MsgOnce
import MsgOnceObj hiding (Msg)
import qualified MsgOnceObj as MO
...
type Parsing i msg = MsgOnceObj () [msg] i msg
{-
...
instance MO.Msg (ParsingMsg st sym pos tk) where
    msg_root = MRoot
newParsing :: WParsing st sym pos tk
newParsing = newMsgOnceObj ()
{-
newParsing :: WParsing st sym pos tk
