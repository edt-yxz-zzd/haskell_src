...
instance (IArrowExit arr) => IArrowThrowBaseBy OnExit_Arrow (ArrSS arr) where
    type ArrowExceptionTypeBy OnExit_Arrow (ArrSS arr) = ArrowExit_Result arr
instance (IArrowExit arr) => IArrowThrowBy OnExit_Arrow (ArrSS arr) where
    throwABy_ = impureArrSS exitA
